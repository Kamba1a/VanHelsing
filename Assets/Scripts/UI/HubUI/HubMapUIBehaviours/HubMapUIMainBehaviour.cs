...
{
    public class HubMapUIMainBehaviour : MonoBehaviour, IHubMapUIStart, IHubMapUIDestroy
    {
        #region PrivateData
        ...
        public void Starting(HubMapUIContext context)
        {
        ...
        private void OnSelectedCharacter(HubMapUICharacterModel previousCharacter)
        {
        ...
        private void OnSelectedMapObject(HubMapUIMapObjectModel previousMapObject)
        {
