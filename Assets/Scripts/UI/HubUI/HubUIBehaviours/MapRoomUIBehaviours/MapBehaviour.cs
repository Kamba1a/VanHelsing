...
namespace BeastHunterHubUI
{
    public class MapBehaviour : MonoBehaviour, IStart, IDestroy
    {
        ...
        public void Starting(HubUIContext context)
        {
            ...
            _context.Player.Inventory.OnPutElementToSlotHandler += FillSlotUI;
            _context.Player.Inventory.OnTakeElementFromSlotHandler += FillSlotUI;
        ...
        private void OnClick_OpenTradePanelButton()
        {
            ...
            city.ShopStorage.OnPutElementToSlotHandler += FillSlotUI;
            city.ShopStorage.OnTakeElementFromSlotHandler += FillSlotUI;

            FillItemStorageSlots(ItemStorageType.BuyBackStorage);
            city.BuyBackStorage.OnPutElementToSlotHandler += FillSlotUI;
            city.BuyBackStorage.OnTakeElementFromSlotHandler += FillSlotUI;
        ...
        private void OnClick_CloseTradePanelButton()
        {
            ...
            selectedCity.ShopStorage.OnTakeElementFromSlotHandler -= FillSlotUI;
        }
        ...
        private void OnSelectedCharacter(CharacterModel previousCharacter)
        {
            if (previousCharacter != null)
            {
                ...
                previousCharacter.Backpack.OnPutElementToSlotHandler -= FillSlotUI;
                previousCharacter.Backpack.OnTakeElementFromSlotHandler -= FillSlotUI;

                previousCharacter.ClothesEquipment.OnPutElementToSlotHandler -= FillSlotUI;
                previousCharacter.ClothesEquipment.OnTakeElementFromSlotHandler -= FillSlotUI;

                previousCharacter.WeaponEquipment.OnPutElementToSlotHandler -= FillSlotUI;
                previousCharacter.WeaponEquipment.OnTakeElementFromSlotHandler -= FillSlotUI;
                previousCharacter.WeaponEquipment.OnTwoHandedWeaponHandler -= FillWeaponSlotUIAsSecondary;

                previousCharacter.Pockets.OnPutElementToSlotHandler -= FillSlotUI;
                previousCharacter.Pockets.OnTakeElementFromSlotHandler -= FillSlotUI;
            ...
            if (_selected.Character != null)
            {
                ...
                _selected.Character.ClothesEquipment.OnPutElementToSlotHandler += FillSlotUI;
                _selected.Character.ClothesEquipment.OnTakeElementFromSlotHandler += FillSlotUI;

                FillItemStorageSlots(ItemStorageType.WeaponEquipment);
                _selected.Character.WeaponEquipment.OnPutElementToSlotHandler += FillSlotUI;
                _selected.Character.WeaponEquipment.OnTakeElementFromSlotHandler += FillSlotUI;
                ...
                _selected.Character.Pockets.OnPutElementToSlotHandler += FillSlotUI;
                _selected.Character.Pockets.OnTakeElementFromSlotHandler += FillSlotUI;
        ...
        private void InitializePocketsSlotsUI(int amount)
        {
            for (int i = 0; i < amount; i++)
            {
                ...
                slotBehaviour.Initialize(i, ItemStorageType.PocketsStorage, true, _data.MapDataStruct.PocketItemSlotIcon);
                slotBehaviour.FillSlot(_selected.Character.Pockets.GetElementSpriteBySlot(i));
                slotBehaviour.OnBeginDragItemHandler = OnBeginDragItemFromSlot;
                slotBehaviour.OnDroppedItemHandler = OnDropItemToSlot;
                slotBehaviour.OnEndDragItemHandler = OnEndDragItem;
        ...
        private void InitializeShopSlotUI(int slotIndex)
        {
            ...
            slotBehaviour.Initialize(slotIndex, ItemStorageType.ShopStorage, false);
            slotBehaviour.SetInteractable(false);
            slotBehaviour.OnPointerDownHandler = OnPointerDown_Slot;
            slotBehaviour.OnPointerEnterHandler = OnPointerEnter_Slot;
            slotBehaviour.OnPointerExitHandler = OnPointerExit_Slot;
        ...
        private void FillCharacterClothesSlot(int slotIndex)
        {
            ...
            _characterClothesSlotsUIBehaviours[slotIndex].OnBeginDragItemHandler += OnBeginDragItemFromSlot;
            _characterClothesSlotsUIBehaviours[slotIndex].OnEndDragItemHandler += OnEndDragItem;
            _characterClothesSlotsUIBehaviours[slotIndex].OnDroppedItemHandler += OnDropItemToSlot;
        ...
        private void FillWeaponSlot(int slotIndex)
        {
            ...
            _characterWeaponSlotsUIBehaviours[slotIndex].Initialize(slotIndex, ItemStorageType.WeaponEquipment, true, slotSprite);
            ...
            _characterWeaponSlotsUIBehaviours[slotIndex].OnBeginDragItemHandler += OnBeginDragItemFromSlot;
            _characterWeaponSlotsUIBehaviours[slotIndex].OnEndDragItemHandler += OnEndDragItem;
            _characterWeaponSlotsUIBehaviours[slotIndex].OnDroppedItemHandler += OnDropItemToSlot;
            ...
            switch (storageType)
            {
                ...
                case ItemStorageType.ShopStorage:
                    ...
                    _shopSlotsUIBehaviours[slotIndex].SetAvailability(HubUIServices.SharedInstance.ShopService.IsPossibleToBuyShopItem
                        (storage.GetElementBySlot(slotIndex), _selected.MapObject as CityModel));
        ...
        private void ClearRightInfoPanel()
        {
         ...
         private void SetStorageSlotsInteractable<T>(bool flag, IEnumerable<T> slotBehaviours) where T : BaseSlotBehaviour<ItemStorageType>
        {
            foreach (BaseSlotBehaviour<ItemStorageType> slot in slotBehaviours)
            {
